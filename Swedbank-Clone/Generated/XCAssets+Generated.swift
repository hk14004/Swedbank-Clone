...
internal enum Asset {
  internal enum Colors {
    ...
    internal static let headlineText = ColorAsset(name: "headlineText")
  ...
  internal enum Images {
    ...
    internal enum Icons {
      internal static let icCardDescription = ImageAsset(name: "ic_card_description")
      internal static let icOverviewDescription = ImageAsset(name: "ic_overview_description")
      internal static let icPaymentsDescription = ImageAsset(name: "ic_payments_description")
      internal static let icServicesDescription = ImageAsset(name: "ic_services_description")
      internal enum LanguageFlag {
        internal static let icEnFlag = ImageAsset(name: "ic_en_flag")
        internal static let icLvFlag = ImageAsset(name: "ic_lv_flag")
      }
    }
  }
}
